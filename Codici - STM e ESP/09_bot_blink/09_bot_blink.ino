...
String ssid = "TISCALI-Wifi";     // REPLACE mySSID WITH YOUR WIFI SSID
String pass = "celiachiaportamivia"; // REPLACE myPassword YOUR WIFI PASSWORD, IF ANY
String token = "913860726:AAGwrd3XgD2clUbDhJ2lRzdLSHOMRMQ1DC0";   // REPLACE myToken WITH YOUR TELEGRAM BOT TOKEN
